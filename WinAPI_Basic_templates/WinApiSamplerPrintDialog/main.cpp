...
LRESULT OnButtonClick(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	if (currentPrintDialog.lStructSize == 0) {
...
int main() {
	window = CreateWindowEx(0, WC_DIALOG, L"Print Dialog example", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 300, 300, nullptr, nullptr, nullptr, nullptr);
