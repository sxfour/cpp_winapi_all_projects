...
int main() {
	window = CreateWindowEx(0, WC_DIALOG, L"TrackBar exampl", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 300, 300, nullptr, nullptr, nullptr, nullptr);
	...
	SendMessage(progressBar, PBM_SETRANGE32, 1, 200);
