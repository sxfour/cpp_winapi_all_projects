...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	if (message == WM_COMMAND && HIWORD(wParam) == EN_CHANGE) {
		return OnTextChanged(hwnd, message, wParam, lParam);
	}
...
int main() {
	window = CreateWindowEx(0, WC_DIALOG, L"TextBox sample", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 300, 300, nullptr, nullptr, nullptr, nullptr);
