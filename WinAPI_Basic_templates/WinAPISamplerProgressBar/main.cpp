...
int main() {
	window = CreateWindowEx(0, WC_DIALOG, L"ProgressBar Ex", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 300, 300, nullptr, nullptr, nullptr, nullptr);
	...
	progressBar5 = CreateWindowEx(0, PROGRESS_CLASS, nullptr, WS_CHILD | PBS_SMOOTH | WS_VISIBLE, 50, 170, 200, 23, window, nullptr, nullptr, nullptr);
	...
	SendMessage(progressBar3, PBM_SETRANGE32, 50, 0);
	SendMessage(progressBar3, PBM_SETPOS, 50, 0);
	SendMessage(progressBar4, PBM_SETRANGE32, 50, 0);
	SendMessage(progressBar5, PBM_SETPOS, 50, 0);
