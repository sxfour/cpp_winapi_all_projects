...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	if (message == WM_CTLCOLORDLG && reinterpret_cast<HWND>(lParam) == window) {
		return OnControlColorDialog(hWnd, message, wParam, lParam);
	}
...
int main() {
	window = CreateWindowEx(0, WC_DIALOG, L"ColorDialog example", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 300, 300, nullptr, nullptr, nullptr, nullptr);
